...
const inputClass =
  "w-full px-4 py-3 border border-gray-300 rounded-lg text-gray-900 focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none";
    ...
    return (
      <div className="text-center">
        ...
        <p className="mt-3 text-gray-600">
          Thanks, {formData.name.split(" ")[0]}! Your details are in. Local garage door companies
          that are hiring will reach out to you directly.
        </p>
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        ...
        <textarea
          id="message"
          rows={3}
          placeholder="e.g. Available weekdays, have my own tools, experience with torsion springs…"
