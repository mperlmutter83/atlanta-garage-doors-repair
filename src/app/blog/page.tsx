...
export const metadata: Metadata = {
  title: 'Blog',
  description: 'Garage door tips, maintenance guides, and repair advice from Atlanta Garage Doors Repair.',
};

const SITE_DOMAIN = 'atlantagaragedoorsrepair.com';
    ...
    <>
      <section className="bg-gradient-to-br from-blue-50 to-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-600 text-lg">Garage door tips, maintenance guides, and repair advice.</p>
        </div>
      </section>

      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-12 text-center">Latest Garage Door Tips and Guides</h2>
